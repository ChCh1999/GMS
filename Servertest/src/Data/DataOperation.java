...
//这里初始化的表还是试验时候的表
    public DataOperation(){
        try{
            ...
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/gms?useUnicode=" +
                    "true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false",
                    "root","123456");
//            "jdbc:mysql://localhost:3306/dbtest?useUnicode=" +
//                    "true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false"
//
//            "jdbc:mysql://localhost:3306/gms?useUnicode=" +
//                    "true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false  "
